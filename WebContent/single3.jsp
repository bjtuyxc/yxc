				...
				<script>
					...
					<!-- pop-up-box -->
									...
									<div id="small-dialog2" class="mfp-hide">
										...
										<div class="signup">
											<form>
												<input type="text" class="email" placeholder="手机号" maxlength="11" pattern="[1-9]{1}\d{10}" title="请输入一个有效的手机号码" />
											</form>
									...
									<div id="small-dialog3" class="mfp-hide">
										...
										<div class="signup">
											<form id="registerForm" onsubmit="reg();">
												<input type="text" id="email" class="email" placeholder="邮箱地址" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?" title="请输入有效的邮箱地址"/>
												<input type="password" id="password" placeholder="密码" required="required" pattern=".{6,}" title="需要至少六个字符" autocomplete="off" />
												<input type="text" id="tel" class="email" placeholder="手机号" maxlength="11" pattern="[1-9]{1}\d{10}" title="请输入有效的手机号码" />
					...
					<div id="small-dialog" class="mfp-hide">
						...
						<div class="signup">
							<form id="loginForm" onsubmit="login();">
								<input type="text" id="email" class="email" placeholder="请输入邮箱地址" required="required" pattern="([\w-\.]+@([\w-]+\.)+[\w-]{2,4})?"/>
								<input type="password" id="password" placeholder="密码" required="required" pattern=".{6,}" title="需要至少六个字符" autocomplete="off" />
								<input type="submit"  value="登录"/>
							</form>
							<div class="forgot">
